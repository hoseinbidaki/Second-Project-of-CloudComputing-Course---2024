...
/**
 * utils.Task is an extention to Cloudlet in CloudSim. It supports the implementation
...
public class Task extends Cloudlet {
    ...
    /**
     * Allocates a new utils.Task object. The task length should be greater than or
     * equal to 1.
     *
     * @param taskId the unique ID of this utils.Task
     ...
     * utils.Task is stored in fileList <tt>Processing Cost = input data transfer +
...
//        cost += costPerBw * fileSize;
    ...
    public List<Task> getCriticalParents(){
        Collections.sort(this.parentList, (t1, t2) ->
                Double.compare(t2.getCriticalCost(), t1.getCriticalCost()));
        return parentList;
    }
