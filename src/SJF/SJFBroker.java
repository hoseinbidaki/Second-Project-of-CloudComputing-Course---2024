...
public class SJFBroker extends DatacenterBroker {
    ...
    public SJFBroker(String name, String daxPath, WorkflowType workflowType) throws Exception {
        super(name);
...
//			sendNow(datacenterId, CloudSimTags.VM_CREATE_ACK, vm);
    ...
    protected void submitCloudlets() {
        ...
        Collections.sort(ReadyTasks, Comparator.comparing(Task::getCloudletLength).reversed());
